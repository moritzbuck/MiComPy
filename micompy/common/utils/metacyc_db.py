from micompy.common.utils.params import metacyc_loc
...
blocks = parse_metacyc_file(metacyc_loc + "/reactions.dat")
reactions = [Reaction(b) for b in blocks]
reactions = {b.id : b for b in reactions}

blocks = parse_metacyc_file(metacyc_loc + "/pathways.dat")
